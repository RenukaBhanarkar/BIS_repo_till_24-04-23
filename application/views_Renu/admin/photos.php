            ...
            <div>
                ...
                <div class="modal fade " id="newform" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog modal-xl" role="document">
                        <form action="<?php echo base_url(); ?>admin/add_photos" method="post" enctype="multipart/form-data">
                        ...
                        <?php if(!empty($photos)){
                            ...
                            <tr>
                                ...
                                <td class="d-flex border-bottom-0">
                                    ...
                                    <button onclick="deletePhotos(' <?php echo $list_photos['id']; ?> ');" data-id ='<?php echo $list_photos['id']; ?>'
