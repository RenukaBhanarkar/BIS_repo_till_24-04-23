                ...
                <div class="card border-top">
                    ...
                    foreach ($allRecords as $row) { ?>
                                ...
                                <div class="mb-2 col-md-4">
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check mr-2">
                                            <input class="form-check-input" type="radio" name="language"  value="1"  <?php if($row['language'] == "English") {echo "checked";} ?>>
                                            <label class="form-check-label" >English</label>
                                        </div>
                                        <div class="form-check mr-2">
                                            <input class="form-check-input" type="radio" name="language"  value="2"   <?php if($row['language']== "Hindi"){echo "checked";}?> >
                                            <label class="form-check-label" >Hindi</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="language" value="3"  <?php if($row['language']== "Both"){echo "checked";}?> >
                        ...
                        <form id="questions_form" action="<?php echo base_url() . 'subadmin/createQuestions' ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" id="que_language" name="que_language" value="<?php echo $lang; ?>">
                            ...
                            <?php if($row['language'] == "English" || $row['language'] == "Both"){ ?>
                            ...
                            <?php } ?>
                            <?php if($row['language'] == "Hindi" || $row['language'] == "Both"){ ?>
