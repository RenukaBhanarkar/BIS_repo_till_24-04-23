    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Quiz Bank Edit</h1>
                            ...
                            foreach ($allRecords as $row) { ?>
                                <form id="que_bank_form" action="<?php echo base_url(); ?>subadmin/editQueBank">
                                        ...
                                        <div class="mb-2 col-md-4">
                                            ...
                                            <div class="d-flex">
                                                <div class="form-check mr-2">
                                                    <input class="form-check-input" type="radio" name="language" value="1" <?php if ($row['language'] == "English") {
                                                                                                                                echo "checked";
                                                                                                                            } ?>>
                                                    <label class="form-check-label">English</label>
                                                </div>
                                                <div class="form-check mr-2">
                                                    <input class="form-check-input" type="radio" name="language" value="2" <?php if ($row['language'] == "Hindi") {
                                                                                                                                echo "checked";
                                                                                                                            } ?>>
                                                    <label class="form-check-label">Hindi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="language" value="3" <?php if ($row['language'] == "Both ") {
                                                                                                                                echo "checked";
                                                                                                                            } ?>>
                                    ...
                                    <div class="col-md-12 submit_btn p-3">
                                        <input type="submit" name="Update" id="editQueBank" class="btn btn-info btn-sm">
                                    </div>
                                </form>
                                <!-- que creation -->
                                <form id="questions_form" action="<?php echo base_url() . 'subadmin/createQuestions' ?>" method="post" enctype="multipart/form-data">
                                    <div class="row mt-2">
                                        <div class="col-md-4 prizes-section">
                                            <h4 class="m-2">Add New Questions</h4>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            <div class="card border-top card-body">
                                                <table id="example" class="hover table-bordered" style="width:100%">
                                                    ...
                                                    <button onClick="" class="btn btn-danger btn-sm mr-2">Delete</button></td> -->
                                                            </tr>
                                                        <?php } ?>
