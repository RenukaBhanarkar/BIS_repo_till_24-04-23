    ...
    <div class="container-fluid">
        ...
        <div class="row mt-3">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="<?php echo base_url().'admin/learning_science_dashboard'; ?>">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center d-flex">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="<?php echo base_url().'subadmin/winner_wall' ?>">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center d-flex">
         ...
         <div class="row standard_club">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center d-flex">
                            <h5 class="font-weight-bold text-danger mb-1">Banner Image word of standard</h5>
                            <!-- <i class="fas fa-dollar-sign fa-2x text-gray-300"></i> -->
                        </div>
                    </div>
                </div>
