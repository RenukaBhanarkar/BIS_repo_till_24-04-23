<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12 mt-3">
            <div class="card border-top">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-4">
                            ...
                            <div>
                                <p><?php echo $quizdata['start_time']; ?></p>
                            </div>
                        </div>
                        <div class="mb-2 col-md-4">
                            <label class="d-block text-font">End Time</label>
                            <div>
                                <p><?php echo $quizdata['end_time']; ?></p>
                            </div>
                        </div>
                        <div class="mb-2 col-md-4">
                    ...
                    <div class="row mt-3">
                        <div class="mb-2 col-md-4">
                            <label class="d-block text-font">Number of Prizes<sup class="text-danger">*</sup></label>
                            <div>
                                <p><?php echo $secondprize['no_of_prize']; ?></p>
                            </div>
                        </div>
                        <div class="mb-2 col-md-4">
                            <label class="d-block text-font">Prize Details<sup class="text-danger">*</sup></label>
                            <div>
                                <p><?php echo $secondprize['prize_details']; ?></p>
                            </div>
                        </div>
                        <div class="mb-2 col-md-4">
                            <label class="d-block text-font">Image<sup class="text-danger">*</sup></label>
                            <div>
                                <p><img src="../../<?php echo $secondprize['prize_img']; ?>" style="width:200px;"></p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row mt-3">
                        <div class="mb-2 col-md-4">
                            <label class="d-block text-font">Number of Prizes<sup class="text-danger">*</sup></label>
                            <div>
                                <p><?php echo $thirdprize['no_of_prize']; ?></p>
                            </div>
                        </div>
                        <div class="mb-2 col-md-4">
                            <label class="d-block text-font">Prize Details<sup class="text-danger">*</sup></label>
                            <div>
                                <p><?php echo $thirdprize['prize_details']; ?></p>
                            </div>
                        </div>
                        <div class="mb-2 col-md-4">
                            <label class="d-block text-font">Image<sup class="text-danger">*</sup></label>
                            <div>
                                <p><img src="../../<?php echo $thirdprize['prize_img']; ?>" style="width:200px;"></p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row mt-3">
                        <div class="mb-2 col-md-4">
                            <label class="d-block text-font">Number of Prizes<sup class="text-danger">*</sup></label>
                            <div>
                                <p><?php echo $fourthprize['no_of_prize']; ?></p>
                            </div>
                        </div>
                        <div class="mb-2 col-md-4">
                            <label class="d-block text-font">Prize Details<sup class="text-danger">*</sup></label>
                            <div>
                                <p><?php echo $fourthprize['prize_details']; ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row mt-3">
                        <div class="mb-2 col-md-4">
                            ...
                            <div>
                                <p><?php echo $quizdata['availability']; ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
                ...
                <div class="col-md-12 submit_btn p-3">
                    <a class="btn btn-primary btn-sm text-white" onclick="location.href='<?php echo base_url(); ?>Quiz/quiz_list'">Back</a>
                </div>
                <!-- Modal -->
        ...
        <?php if (encryptids("D", $_SESSION['admin_type']) == 2) { ?>
            <div class="col-12 mt-3">
                <form name="quiz_reg" action="<?php echo base_url() . 'Admin/updateQuizStatus/' . $quizdata['id'] ?>" method="post" enctype="multipart/form-data">
                    <div class="row" id="remarkdiv">
                        <div class="mb-2 col-md-8">
                            <label class="d-block text-font" text-font>Remarks<sup class="text-danger">*</sup></label>
                            <textarea class="form-control input-font" placeholder="Enter Remark" name="remark" id="remark"><?php echo set_value('terms_conditions'); ?></textarea>
