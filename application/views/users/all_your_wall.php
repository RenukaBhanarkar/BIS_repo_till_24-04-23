...
<section>
            ...
            <div class="row">
              <div class="col-md-3">
               <div class="static-content">
                  <div class="bloginfo">
                       <h3 style="margin-bottom: 0px;margin-top:20px;color: #0086b2!important;font-weight: 600;">Your Wall</h3>
                   </div>
        ...
        <?php foreach($published_wall as $list){ ?>
            <div class="col-md-4">
            <a href="<?php echo base_url().'users/yourwallview/'.$list['id']; ?>">
                <div class="card-winners">
                        
                            <img src="<?php echo base_url().'uploads/your_wall/'.$list['image']; ?>" class="card-img-top" alt="Discussion Forum">
