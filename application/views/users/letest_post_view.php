    ...
    <div class="join_content">
        ...
        <div class="join_container">
            ...
            <div class="view_join_content">
                <a href="<?php echo base_url().'users/letest_post_readMore/'?><?php echo encryptids("E", $value['id'] )?>">
                ...
                <div class="join_body">
                    <div class="title_join">
                        <h3><a href="<?php echo base_url().'users/letest_post_readMore/'?><?php echo encryptids("E", $value['id'] )?>"><?= $value['title']?></a></h3>
                        <span class="last-date">Date:<span class="date-time" style="margin-left: 5px;"><?= date("d M Y", strtotime($value['created_on']));?></span></span>
                        <a href="<?php echo base_url().'users/letest_post_readMore/'?><?php echo encryptids("E", $value['id'] )?>"><div class="discuss_caption"><span href="#" title=" Discuss" style="padding:8px;"></span><span class="">Read More</span></div></a>
