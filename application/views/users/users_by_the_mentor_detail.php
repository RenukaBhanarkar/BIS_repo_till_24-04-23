...
<div class="row mt-5">
              <div class="col-md-3">
               <div class="static-content">
                  <div class="bloginfo">
                       <h3 style="margin-bottom: 0px;margin-top:20px;color: #0086b2!important;font-weight: 600;">By The Mentor</h3>
                   </div>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="your_wall_main_card_view">
                        <div class="yourWall_image">
                            ...
                            <span><i class="fa fa-calendar icons"><?php echo $by_the_mentor['created_on']; ?></i></span>
                        </div>
                        <div class="Text-container_view ">
                            <h6 class="yourWall_title_view ">
                            <?php echo $by_the_mentor['title']; ?>
                                <!-- Lorem ipsum dolor sit amet, consectetur -->
                            </h6>
                            <p class="Your_Wall_Description_view">
                            <?php echo $by_the_mentor['description']; ?>
                            </p>
