...
<div class="container-fluid">
    ...
    <form name="live_session_edit" id="live_session_edit" action="<?php echo base_url().'Standardsmaking/live_session_edit'?>/<?= $liveSession['id']?>" method="post"enctype="multipart/form-data">
            ...
            <div class="col-12 mt-3">
                <div class="card border-top">
                    <div class="card-body">
                        <div id="english_div">
                            <div class="row">
                                <input type="hidden" name="lastvideo" value="<?= $liveSession['video']?>">
                                <input type="hidden" name="lastthumbnail" value="<?= $liveSession['thumbnail']?>">
                                <input type="hidden" name="lastimage" value="<?= $liveSession['image']?>">
                                <input type="hidden" name="lastdoc_pdf" value="<?= $liveSession['doc_pdf']?>">
                                <input type="hidden" name="id" value="<?= $liveSession['id']?>">
                                <div class="mb-2 col-md-4">
                                    ...
                                    <select id="type_of_post" name="type_of_post" class="form-control input-font" onchange="getval(this.value)">
                                        ...
                                        <option value="1"
                                        <?php if ($liveSession['type_of_post'] == '1')  echo 'selected = "selected"'; ?>>Text Upload</option>
                                        <option value="2" <?php if ($liveSession['type_of_post'] == '2')  echo 'selected = "selected"'; ?>>Video Upload</option>
                                        <option value="3" <?php if ($liveSession['type_of_post'] == '3')  echo 'selected = "selected"'; ?>>Live session link</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-2 col-md-8">
                                    ...
                                    <input type="text" class="form-control input-font" name="title" id="title" value="<?= $liveSession['title']?>" placeholder="Enter Title">
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-2 col-md-12">
                                    <label class="d-block text-font" text-font>Description<sup class="text-danger">*</sup></label>
                                    <textarea class="form-control input-font" placeholder="Enter Description" name="description" id="description"><?= $liveSession['description']?></textarea>
                            ...
                            <div class="row" id="link_session">
                                <div class="mb-2 col-md-8">
                                    ...
                                    <input type="text" class="form-control input-font" name="session_link" id="session_link" placeholder="Enter Title" value="<?= $liveSession['session_link']?>">
                                </div>
                            </div>
                            
                            <div class="row" id="text_image">
                                <div class="mb-2 col-md-4">
                                    <?php if(empty($liveSession['image'])){?>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a onclick="deleteLiveSessionFile(' <?= $liveSession['id']?> ',1);" data-id='<?php echo $value["id"]; ?>' class="btn btn-danger btn-sm mr-2 delete_img">Delete</a>
                                        <?php } ?>
                                    </div>
                                </div>
                                <!-- Modal -->
                                    ...
                                    <div class="modal-dialog" style="max-width:700px;">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img src="<?= base_url()?><?= $liveSession['image']?>" width="100%"/>
                                            </div>
                            ...
                            <div class="row" id="video_thumbnail">
                                <div class="mb-2 col-md-4">
                                    <?php if(empty($liveSession['thumbnail'])){?>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a onclick="deleteLiveSessionFile(' <?= $liveSession['id']?> ',2);" data-id='<?php echo $value["id"]; ?>' class="btn btn-danger btn-sm mr-2 delete_img">Delete</a>
                                        <?php }?>
                                    </div>
                                </div>
                                ...
                                <div class="modal fade" id="LastThumbnailModal" tabindex="-1" aria-labelledby="lastThumbnailModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" style="max-width:700px;">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img  src="<?= base_url()?><?= $liveSession['thumbnail']?>"width="100%"/>
                                            </div>
                                            <div class="modal-footer">
        ...
        var argument="<?= $liveSession['type_of_post']?>";
        getval(argument)
        });
        ...
        var doc_pdfdata="<?= $liveSession['doc_pdf']?>";
        ...
        var thumbnaildata="<?= $liveSession['thumbnail']?>";
        if (thumbnaildata=='')
        {
        ...
        var imagedata="<?= $liveSession['image']?>";
        ...
        <script type="text/javascript">
        function deleteLiveSessionFile(id,val)
        {
        console.log(val)
